...
class finalterm extends StatefulWidget {
  const finalterm({Key? key}) : super(key: key);

  @override
  State<finalterm> createState() => _finaltermState();
}

class _finaltermState extends State<finalterm> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
       ...
       title: Text("Final Term",style: TextStyle(
