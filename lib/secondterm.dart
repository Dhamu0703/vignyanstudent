...
class secondterm extends StatefulWidget {
  const secondterm({Key? key}) : super(key: key);

  @override
  State<secondterm> createState() => _secondtermState();
}

class _secondtermState extends State<secondterm> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
       ...
       title: Text("Second Term",style: TextStyle(
