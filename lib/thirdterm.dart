...
class thirdterm extends StatefulWidget {
  const thirdterm({Key? key}) : super(key: key);

  @override
  State<thirdterm> createState() => _thirdtermState();
}

class _thirdtermState extends State<thirdterm> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
       ...
       title: Text("Third Term",style: TextStyle(
